...
| Edit product              | Earlier visual state superseded by the final blocker repair               | Earlier responsive layout remains unchanged     | Final copy now uses `Save changes` and explains which edits clear verification; source, tests, and build were rechecked without live DB mutation. |
